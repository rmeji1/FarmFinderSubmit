...
import com.farmfinder.properties.PropertiesLookup;
import com.mongodb.*;
...
public class MongoRealm extends RealmBase {
    ...
    protected String credentialsField = "pass";
    ...
    public synchronized Principal authenticate(String username, String credentials) {
        ...
        if (dbCredentials != null) {
            ...
            if (hasMessageDigest()) {
                ...
                validated =credentials.equalsIgnoreCase(dbCredentials) ; //(digest(credentials).equalsIgnoreCase(dbCredentials));
            } else {
                validated = credentials.equalsIgnoreCase(dbCredentials);//(digest(credentials).equals(dbCredentials));
            }
    ...
    private DB openMongoDB() throws UnknownHostException {
        ...
        if (mongoClient == null) {
            mongoClient = new MongoClient( lookup.getProperty("mongodbURL"),Integer.parseInt(lookup.getProperty("mongodbPORT")) );
        }
    ...
    protected String getPassword(String username) {
        ...
        try {
            ...
            // Log the problem for posterity
            containerLog.error(String.format("Unknown host exception, Mongo URI: %s"), e);
    ...
    public static void main(String[] args){
    	...
    	System.out.println(realm.authenticate("robertmejia30@gmail.com", "ro123258")) ;
